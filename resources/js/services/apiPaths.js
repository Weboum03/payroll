...
const getApiPath = {
    ...
    getBadgeLogsByType(id,type, params = '') { return apiService.get(`admin/batches/${id}/logs/${type}${params}`); },
    ...
    downloadDocument(id, type, params) { return apiService.get(`admin/batches/${id}/donwload_doc/${type}`, params); },
